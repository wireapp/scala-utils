...
/**
  ...
  */
abstract class TestSpec extends FeatureSpec with scalatest.Matchers with OptionValues with BeforeAndAfter with BeforeAndAfterAll with OneInstancePerTest with MockFactory {
