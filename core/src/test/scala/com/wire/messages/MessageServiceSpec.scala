...
import com.wire.data.{GenericMessageEvent, MessageEvent, UId, UserId}
...
//    val assetEvent = GenericMessageEvent()
  ...
  /**
    ...
    */
  def generateEvents(conv: ConversationData, sender: UserId, fromTime: Instant, before: Boolean, count: Int = 3): Seq[MessageEvent] = {
